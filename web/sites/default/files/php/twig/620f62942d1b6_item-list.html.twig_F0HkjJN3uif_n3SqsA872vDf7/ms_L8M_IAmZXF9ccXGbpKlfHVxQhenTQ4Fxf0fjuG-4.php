...
class __TwigTemplate_568000d73cbdfcf6563cc29a60d8276a6ad55477e5216aeb575868c9c0345d27 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if ((($context["items"] ?? null) || ($context["empty"] ?? null))) {
            ...
            if (($context["items"] ?? null)) {
                ...
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "list-group"], "method", false, false, true, 32), 32, $this->source), "html", null, true);
                echo ">";
                // line 33
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 34
                    echo "<li";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 34), "addClass", [0 => "list-group-item"], "method", false, false, true, 34), 34, $this->source), "html", null, true);
                    echo ">";
    ...
    {
        return new Source("", "themes/contrib/bootstrap_barrio/templates/dataset/item-list.html.twig", "/var/www/html/web/themes/contrib/bootstrap_barrio/templates/dataset/item-list.html.twig");
    }
